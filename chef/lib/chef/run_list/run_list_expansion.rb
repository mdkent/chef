  ...
  class RunList
    ...
    class RunListExpansion
      ...
      def apply_role_attributes(role)
        @default_attrs = Chef::Mixin::DeepMerge.merge_for_role_attrs(@default_attrs, role.default_attributes)
        @override_attrs = Chef::Mixin::DeepMerge.merge_for_role_attrs(@override_attrs, role.override_attributes)
      end
