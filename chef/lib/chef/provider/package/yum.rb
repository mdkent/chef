      ...
      class Yum < Chef::Provider::Package
        ...
        class YumCache
          ...
          def refresh
            ...
            yd = shell_out("/usr/bin/python #{helper}#{opts}")
            yd.stdout.each_line do |line|
              one_line = true
            ...
            if yd.exitstatus != 0
              raise Chef::Exceptions::Package, "Yum failed - #{yd.stdout} - returns: #{yd.stderr} (exit #{yd.exitstatus})"
            else
              unless one_line
